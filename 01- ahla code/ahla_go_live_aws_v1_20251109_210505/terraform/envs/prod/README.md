...
# Ahla — Go‑Live AWS (prod env)
## المتطلبات
- VPC/Subnets جاهزة
- شهادة ACM (DNS-validated) و Zone في Route53
- صور Docker مرفوعة إلى ECR

## الاستخدام
1) اضبط المتغيرات في `prod.tfvars` (مثال أدناه).
2) `terraform init && terraform apply -var-file="prod.tfvars"`
...
img_moments_api = "1111.dkr.ecr.me-central-1.amazonaws.com/ahla-moments-api:prod"
img_emotion_api = "1111.dkr.ecr.me-central-1.amazonaws.com/ahla-emotion-api:prod"
img_voice_api   = "1111.dkr.ecr.me-central-1.amazonaws.com/ahla-voice-api:prod"
