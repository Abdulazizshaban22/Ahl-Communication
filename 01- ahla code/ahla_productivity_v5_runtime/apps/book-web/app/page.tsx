...
export default function Book(){
  ...
  const editor = useEditor({
    extensions:[StarterKit, Collaboration.configure({ document: ydoc }), CollaborationCursor.configure({ provider, user: { name: 'Editor', color: '#a0a' }})],
    content: '<h1>Ahla Book</h1><p>Collaborative document ready.</p>'
  })
